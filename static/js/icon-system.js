...
(function(){
  ...
  var icons = {
    ...
    sitemap: svg('<path d="m3.5 6.5 5.5-3 6 3 5.5-3v14l-5.5 3-6-3-5.5 3Z"/><path d="M9 3.5v14.8M15 6.5v14.8"/><circle cx="15.2" cy="10.4" r="1.8"/>'),
    ...
    volume: svg('<path d="M4.5 10h3.8l4-3.3v10.6l-4-3.3H4.5Z"/><path d="M15.2 9.1a4.2 4.2 0 0 1 0 5.8"/><path d="M17.8 6.5a7.8 7.8 0 0 1 0 11"/>'),
